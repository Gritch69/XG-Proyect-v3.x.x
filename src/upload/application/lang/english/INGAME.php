...
$lang['ov_abandon_planet_not_possible']     = 'It\'s not possible to abandon a planet when there are fleets moving';
...
$lang['gl_multi_alarm']                     = 'Error, multi alarm';
$lang['gl_send']                            = 'Send';
$lang['gl_ship']                            = 'ship';
$lang['gl_ships']                           = 's';
$lang['gl_to']                              = 'to';
...
$lang['fl_expedition_fleets_limit']         = 'Expedition flying fleets limit reached!';
...
$lang['fl_fleets_movements']                = 'Fleet movements';
$lang['fl_fleet_union']                     = 'Fleet union';
...
603 => 'The Engineer is a specialist in energy management. In peacetime, it increases the energy of all the colonies. In case of attack, ensuring the supply of energy to the cannons, and avoid a possible overload, leading to a reduction in defense lost battle.',
604 => 'Geologist is an expert in mining and astro crystallography. Attend their equipment in metallurgy and chemistry and is also responsible for interplanetary communications to optimize the use and refinement of raw material throughout the empire.',
605 => 'The guild is composed of technocrats authentic genius, and always find that dangerous edge where it all explode into a thousand pieces before they could find an explanation and technology rational. No normal human being ever try to decode the code of a technocrat, with its presence, the researchers modeled the rule.',
);
...
$lang['al_tag_required']                    = 'Alliance tag too short';
$lang['al_name_required']                   = 'Alliance name too short';
$lang['al_name_already_exists']             = 'The alliance name "%s" already exists.';
$lang['al_tag_already_exists']              = 'The alliance tag "%s" already exists.';
...
$lang['al_back']                            = 'Back to main view';
$lang['al_actions']                         = 'Actions';
$lang['al_change_title']                    = 'How should the alliance "%s" be called from now on?';
...
$lang['al_make_alliance_name_required']     = 'Alliance name (3-30 characters)';
...
$lang['al_confirm_remove_member']           = 'Are you sure you want to expel %s?';
...
//----------------------------------------------------------------------------//
//OPTIONS
$lang['op_cant_activate_vacation_mode']     = 'If you\'re building or moving fleets, you will not be able to enter on vacation mode.';
...
$lang['sys_moonbuilt']                      = "The huge amount of metal and glass are merging and form a lunar satellite in orbit the planet %s [%d:%d:%d] !";
...
$lang['sys_colo_maxcolo']                   = ", but, unfortunately, you cannot colonize because you maximum colony limit has been reached";
...
$lang['sys_destruc_echec']                  = ". The tremors began to shake off the surface of the moon, but something goes wrong, the graviton in the death stars also causes tremors and death stars fly to pieces.";
...
$lang['sys_destruc_null']                   = ", The death stars did not generate the power, the mission fails and the ships returned home.";
$lang['sys_the']                            = " the ";
...
$lang['ma_impulse_drive_required']          = 'You must develop the Impulse Drive.';
...
$lang['ma_planet_without_defens']           ='Planet without defenses';
